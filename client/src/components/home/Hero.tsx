...
export default function Hero() {
  ...
  return (
    <section 
      id="hero" 
      className="relative pt-8 bg-blue-800 px-4"
      ref={ref}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-blue-800/95 to-blue-900/95"></div>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-18 md:py-32">
        <motion.div
        ...
        >
          <div>
            ...
            >
              <Button 
                size="lg"
                className="bg-orange-500 !font-bold text-lg !text-white hover:bg-orange-600 max-w-sm"
                asChild
              >
      ...
      <svg className="fill-white w-full h-20" viewBox="0 0 1440 48" preserveAspectRatio="none">
